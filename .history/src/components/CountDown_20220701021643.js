...
export default function CountDown() {
  ...
  return (
    ...
    <h1>Count Down Using React JS</h1>
      <form ref={formData}>
        <input className='form-control inline' name='minutes' type="number" placeholder='minutes' />&nbsp;
        <input className='form-control inline' name='seconds' type="number" placeholder='seconds' />&nbsp;
